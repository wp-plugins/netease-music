...
add_action('template_redirect', 'wp_xiami_template', 1 );
...
function nm_player(){
    ...
    echo '<div class="nmplaybar"><div class="nmplayer-prosess"></div><div class="nmplayer-wrap"><div class="nmplayer-info"><span class="nmplayer-title"></span><span class="nmplayer-time"></span><span class="nmplayer-lrc"></span></div><div class="nmplayer-control">
<ul>
<li>
...
</div></div></div><div id="jp_container_N" style="display:none"><div id="jquery_jplayer_N" style="display:none"><div class="jp-playlist"><ul class=""><li></li></ul></div></div></div>';
}
