var q = "Microsoft Internet Explorer" == window.navigator.appName || "Netscape" == window.navigator.appName && /trident\/\d\.\d/i.test(window.navigator.userAgent) ? "flash, html": "html, flash",
    ...
    myPlaylist;
        ...
        function() {
			...
			title = a.data('title'),
			type = a.data('type'),
			mod = '<div class="audio-jplayer album--wrapper" id="jp_container_N"><div class="album--title">' + a.data('tooltip') + '</div><div class="content-with-thumb"><div class="jp-type-playlist"><div id="jquery_jplayer_N"></div><div class="jp-playlist"><ul class=""><li></li></ul></div></div><img class="play-thumb" src="' + a.data('thumbnail') + '"></div></div>',
