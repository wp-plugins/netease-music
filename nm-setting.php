<div class="wrap">
    ...
    <form method="post" action="options.php">
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                <th scope="row"><label for="<?php echo nm_setting_key('loadcss');?>">CSS文件</label></th>
                <td>
                    <label for="<?php echo nm_setting_key('loadcss');?>">
                        <input type="checkbox" name="<?php echo nm_setting_key('loadcss');?>" id="loadcss" value="1" <?php if(nm_get_setting("loadcss")) echo 'checked="checked"';?>>自行载入CSS文件
                    </label>
                    <p class="description">如果你自定义了样式或者集成到主题的CSS中可以勾选此选项。</p>
                </td>
            </tr>
            </tbody>
        </table>
